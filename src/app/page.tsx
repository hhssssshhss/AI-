...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-radial from-[#1e1b4b] via-[#090514] to-[#020005] text-slate-100 flex flex-col items-center justify-center px-6 overflow-hidden">
      {/* Decorative Blur Backgrounds */}
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-indigo-500/10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-purple-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>

      <main className="z-10 max-w-4xl w-full text-center space-y-12 py-16">
        {/* Logo and Icon */}
        <div className="space-y-4">
          <div className="inline-flex items-center justify-center p-3 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 shadow-[0_0_20px_rgba(99,102,241,0.25)] animate-bounce">
            <Sparkles className="w-10 h-10 text-indigo-400" />
          </div>
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight bg-clip-text bg-gradient-to-r from-white via-indigo-100 to-purple-300">
            CareerFolio
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-3xl mx-auto text-left">
          {/* Card 1 */}
          <div className="bg-white/5 border border-white/5 p-5 rounded-2xl space-y-3 hover:border-white/10 hover:bg-white/10 transition-all duration-300">
