...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col md:flex-row font-sans">
      {/* Sidebar - Desktop */}
      <aside className="hidden md:flex flex-col w-64 bg-slate-100/50 border-r border-slate-200 p-6 z-10 shrink-0 print:hidden">
        {/* Brand */}
      ...
      {/* Header - Mobile */}
      <header className="md:hidden bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between z-20 sticky top-0 print:hidden">
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col min-w-0 z-10 relative overflow-y-auto max-h-screen bg-slate-50 print:overflow-visible print:max-h-none print:bg-white">
